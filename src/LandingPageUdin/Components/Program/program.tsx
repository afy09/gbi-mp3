...
const ProgramKerja = () => {
  ...
  const norek = "1234567890"; // ganti sesuai nomor rekening
    ...
    <div className="bg-black2 py-10 px-10">
      ...
      {showPopup && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-lg p-6 w-96 max-sm:w-[320px] text-center relative">
            ...
            <div className="mb-1 flex justify-start text-sm">greja MP3 - BCA</div>
            ...
            <p className="text-gray-700 ">
              Mohon diperhatikan no rekening atas nama{" "}
              <span
                className="font-bold
            ">
                gereja MP3
